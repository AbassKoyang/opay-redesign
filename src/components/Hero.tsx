  ...
  return (
    <section className="w-full min-h-dvh bg-[url(/assets/images/background-img.png)] flex items-center justify-center overflow-hidden relative">
        <div className="mt-[-50px] lg:mt-[170px] flex flex-col justify-center items-center">
            ...
            <img id='hero-img' src="/assets/images/hero-phones.png" alt="Images of Opay's UI"  className="hero-text-animation absolute bottom-0 left-[50%] translate-x-[-50%] lg:static lg:translate-x-0 opacity-0 mt-[70px] lg:mt-[80px] w-[350px] lg:w-fit translate-y-[20px] lg:translate-y-0"/>
        </div>
    </section>
  )
}
